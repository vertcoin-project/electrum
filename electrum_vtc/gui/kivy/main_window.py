...
class ElectrumWindow(App, Logger):
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.electrum_vtc.qr.SimpleScannerActivity")
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            self.show_error(_("Not available for this wallet.") + "\n\n" +
                            _("No BOLT compatible implementation exists yet"))
    ...
    def init_ui(self):
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-vtc.png"
